...
export const appCommands: AppCommand[] = [
  {
    id: "ask-lifeos",
    label: "Ask AZIO",
    keywords: ["ai", "chat", "assistant", "brain", "azio", "lifeos"],
    group: "Ask",
    icon: Sparkles,
  ...
  {
    id: "view-momentum",
    label: "View AZIO Momentum",
    keywords: ["score", "analytics", "pulse", "azio"],
    group: "Navigate",
    icon: BarChart3,
  ...
  },
  {
    id: "open-azio",
    label: "Open AZIO",
    keywords: ["home", "dashboard", "overview", "azio", "lifeos"],
    group: "Navigate",
    icon: Home,
  ...
  },
  {
    id: "open-ai",
    label: "Open AZIO AI",
    keywords: ["chat", "assistant", "ask", "azio", "lifeos"],
    group: "Ask",
    icon: Sparkles,
    action: { kind: "navigate", href: "/ai" },
  },
  ...
  {
    id: "go-analytics",
    label: "Open AZIO Analytics",
    keywords: ["open", "insights", "momentum", "patterns", "azio"],
    group: "Navigate",
    icon: BarChart3,
  ...
  },
  {
    id: "open-billing",
    label: "Open Billing",
    keywords: ["plan", "pro", "razorpay", "subscription", "upgrade"],
    group: "Navigate",
    icon: CreditCard,
    action: { kind: "navigate", href: "/settings/billing" },
  },
  {
    id: "upgrade-to-pro",
    label: "Upgrade to Pro",
    keywords: ["billing", "pricing", "razorpay", "subscribe"],
    group: "Navigate",
    icon: CreditCard,
    action: { kind: "navigate", href: "/pricing" },
  },
  {
    id: "view-pricing",
    label: "View Pricing",
    keywords: ["plans", "free", "pro", "cost"],
    group: "Navigate",
    icon: CreditCard,
    action: { kind: "navigate", href: "/pricing" },
  },
